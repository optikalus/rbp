...
<head>
  <title><?=$config[title]?> Account Administration</title>
...
<table border='0' cellpadding='4' cellspacing='0' class='main'>
  <tr class='title'>
    <td colspan='2'>Account Administration</td>
  </tr>
  ...
  <tr<? if (isset($err_array[password_old])) print " style='background-color: #ff9999'"; ?>>
    <td>Old Password: </td>
    <td><input type='password' name='password' size='22' maxlength='255' value='' /></td>
  </tr>
  <tr<? if (isset($err_array[password_new])) print " style='background-color: #ff9999'"; ?>>
    <td>New Password</td>
  ...
  <tr>
  <tr>
    <td colspan='2' align='center'><input type='submit' value='Update' /> <input type='reset' /></td>
  </tr>
</table>
    </td>
  </tr>
